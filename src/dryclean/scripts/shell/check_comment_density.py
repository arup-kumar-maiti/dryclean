"""
Check that no Shell file exceeds the max allowed comment-to-code ratio.

usage:
  python scripts/shell/check_comment_density.py [--max-ratio 0.15] [FILE ...]
"""
...
def _is_comment_line(line: str) -> bool:
    return line.startswith(_COMMENT_PREFIX) and not line.startswith(_SHEBANG_PREFIX)

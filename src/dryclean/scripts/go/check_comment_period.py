"""
Check that standalone Go comments follow the period punctuation rule.

usage:
  python scripts/go/check_comment_period.py [FILE ...]
"""
...
_COMMENT_PREFIX = "//"
_DIRECTIVE_PATTERN = re.compile(r"^\s*(?:go:|nolint:|//go:)")
_PERIOD = "."

"""
Check that standalone HTML comments follow the period punctuation rule.

usage:
  python scripts/html/check_comment_period.py [FILE ...]
"""
...
_BLOCK_CLOSE = "-->"
_BLOCK_OPEN = "<!--"
_DIRECTIVE_PATTERN = re.compile(r"^\s*(?:prettier|htmlhint)")
_PERIOD = "."
